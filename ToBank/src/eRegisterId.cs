...
namespace ToBank
{
	...
	public enum eRegisterId
	{
		...
		ID_DatosBancarios_Límite_de_Tarjeta,
		/* Datos personales */
		...
		ID_DatosPersonales_Número_de_Documento,
		ID_DatosPersonales_Posición_ante_el_IVA,
		ID_DatosPersonales_Tipo_Clave_Tributaria,
		ID_DatosPersonales_Número_Clave_Tributaria,
		...
		ID_DomPart_Código_Postal,
		ID_DomPart_Localidad,
		ID_DomPart_Código_de_Provincia,
		ID_DomPart_Teléfono,
		ID_DomPart_Fax,
		/* Domicilio laboral */
		ID_DomLab_Calle,
		...
		ID_DomLab_Código_Postal,
		ID_DomLab_Localidad,
		ID_DomLab_Código_de_Provincia,
		ID_DomLab_Teléfono,
		ID_DomLab_Fax,
		/* Datos 2do Titular */
		...
		ID_DatosSdoTitular_Número_de_Documento,
		ID_DatosSdoTitular_Posición_ante_el_IVA,
		ID_DatosSdoTitular_Tipo_Clave_Tributaria,
		ID_DatosSdoTitular_Número_Clave_Tributaria,
		...
		ID_DomPartSdoTitular_Número,
		ID_DomPartSdoTitular_Piso,
		ID_DomPartSdoTitular_Departamento,
		ID_DomPartSdoTitular_Código_Postal,
		ID_DomPartSdoTitular_Localidad,
		ID_DomPartSdoTitular_Código_de_Provincia,
		ID_DomPartSdoTitular_Teléfono,
		ID_DomPartSdoTitular_Fax,
		/* Domicilio Laboral 2do Titular */
		ID_DomLabSdoTitular_Calle,
		ID_DomLabSdoTitular_Número,
		ID_DomLabSdoTitular_Piso,
		ID_DomLabSdoTitular_Departamento,
		ID_DomLabSdoTitular_Código_Postal,
		ID_DomLabSdoTitular_Localidad,
		ID_DomLabSdoTitular_Código_de_Provincia,
		ID_DomLabSdoTitular_Teléfono,
